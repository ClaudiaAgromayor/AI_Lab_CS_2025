...
class QLearningAgent(ReinforcementAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Counter returns 0.0 for unseen (state, action) pairs automatically
    ...
    def computeActionFromQValues(self, state):
        ...
        # Find all actions that achieve the maximum Q-value
    ...
    def getAction(self, state):
        ...
        if util.flipCoin(self.epsilon):
            ...
            # Exploit: choose best action according to current Q-values
    ...
    def update(self, state, action, nextState, reward: float):
        ...
        # Calculate new Q-value using the update rule
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        # Calculate Q(s,a) = Σ fi(s,a) * wi (dot product)
        qValue = 0.0
    ...
    def update(self, state, action, nextState, reward: float):
        ...
        # Calculate current Q-value and next state value
        currentQ = self.getQValue(state, action)
        nextStateValue = self.computeValueFromQValues(nextState)
        
        # Calculate difference (same as in regular Q-learning)
        difference = (reward + self.discount * nextStateValue) - currentQ
        
        # Update each weight: wi ← wi + α * difference * fi(s,a)
        for feature, featureValue in features.items():
