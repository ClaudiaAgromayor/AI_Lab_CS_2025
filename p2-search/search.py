...
def depthFirstSearch(problem: SearchProblem) -> List[Directions]:
    ...
    "*** YOUR CODE HERE ***"
    stack = util.Stack()
    stack.push((problem.getStartState(), [])) #push adds an item to the top of the stack
...
def breadthFirstSearch(problem: SearchProblem) -> List[Directions]:
    ...
    "*** YOUR CODE HERE ***"
    queue = util.Queue()
    queue.push((problem.getStartState(), [])) #push adds an item to the top of the stack
...
def uniformCostSearch(problem: SearchProblem) -> List[Directions]:
    ...
    priority_queue.push((problem.getStartState(), []), 0) #push adds an item to the top of the stack
        ...
        if current_state not in visited:
            ...
            for successor, action, step_cost in problem.getSuccessors(current_state):
                if successor not in visited:
                    ...
                    priority_queue.push((successor, new_path), total_cost)
    util.raiseNotDefined()
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic) -> List[Directions]:
    ...
    while not priority_queue.isEmpty():
        ...
        if current_state in best_costs and current_cost > best_costs[current_state]:
            continue
        ...
        for successor, action, step_cost in problem.getSuccessors(current_state):
            ...
            if successor not in best_costs or new_cost < best_costs[successor]:
                ...
                priority_queue.push((successor, new_path), priority)
